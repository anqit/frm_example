...
case class Address(number: Int, street: String, createdAt: Instant, updatedAt: Instant, userId: Int, id: Option[Int] = None) extends Id[Address] with Timestamps[Address] {
